...
function App({ Component, pageProps }) {
  ...
  return (
    <>
      <Head>
        <title>Power Street Pro</title>
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Power Street Pro" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content="Power Street Pro, Serum, SRM, Serum DEX, DEFI, Decentralized Finance, Decentralised Finance, Crypto, ERC20, Ethereum, Decentralize, Solana, SOL, SPL, Cross-Chain, Trading, Fastest, Fast, SerumBTC, SerumUSD, SRM Tokens, SPL Tokens"
        />
        <meta
          name="description"
          content="Power Street Pro - Decentralised, cross-margin trading up to 10x leverage with lightning speed and near-zero fees."
        />
        <link
        ...
        <meta name="twitter:title" content="Power Street Pro" />
        <meta
          name="twitter:description"
          content="Power Street Pro - Decentralised, cross-margin trading up to 20x leverage with lightning speed and near-zero fees."
        />
